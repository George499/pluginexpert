...
function ThirdScreen() {
  ...
  >
    ...
    <div className="text-[16px] lg:text-[20px] tracking-normal pt-6 mb-6">
      <p className="mb-4">
        ПРЯМАЯ РЕЧЬ СПИКЕРЫ БЕЗ ПОСРЕДНИКОВ — ресурс по самостоятельному подбору спикеров.
      </p>
      ...
      <ul className="list-disc pl-5 list-inside pt-3.5 mb-4">
        {["Продажи", "Маркетинг", "Большие данные", "Цифровые технологии", "Продвижение в интернете"].map((li) => (
          <li key={li}>{li}</li>
        ))}
      </ul>
