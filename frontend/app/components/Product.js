      ...
      {speaker ? (
        <div className="group relative">
          ...
          </Link>
          {
            <>
              <div
                className={`hidden absolute w-full h-full top-0 left-0 lg:flex flex-col items-center justify-center text-center bg-[#4e5ac3] lg:opacity-0 lg:group-hover:opacity-100 opacity-60 transition-opacity-60 duration-700`}
              >
